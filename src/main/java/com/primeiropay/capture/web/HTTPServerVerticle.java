package com.primeiropay.capture.web;
...
import com.primeiropay.capture.model.CaptureRequestModel;
...
public class HTTPServerVerticle extends AbstractVerticle {
    ...
    public void start(final Future<Void> startFuture) {
    	...
    	router.post("/capture/:id").handler(this::doCapture);
    ...
    private JsonObject captureToPrimeiroPay(String payload, String authId, String authorizationToken) throws IOException {
